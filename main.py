...
def main():
    ...
    TABU_LENGTH = [80, 100, 120, 140, 160, 180]
...
# ------------------------------------------------ INITIALIZATION -------------------------------------------------------
        ...
        # ------------------------------------------------- SIMULATION ---------------------------------------------------------
            ...
            for day in range(n_days):
                ...
                while not(solution):
                    ...
                    if solver == 'ortools':
                        ...
                        if solution:
                            tabu_search = TabuSearch(clark_wright_sol, constant.MAX_TIME, tabu_len, perc_worse)
            ...
            print('Perc Worse {} Tabu Length {}'.format(perc_worse, tabu_len))
