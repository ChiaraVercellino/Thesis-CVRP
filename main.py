        ...
        for perc_sw in PERC_SWAP:
            for num_p in NUM_PERM:
                ...
                # ------------------------------------------------- SIMULATION ---------------------------------------------------------
                    ...
                    for day in range(n_days):
                        ...
                        while not(solution):
                            ...
                            if solver == 'ortools':
                                ...
                                elapsed_time = 0
                                clark_wright_sol = ClarkWrightSolver(updated_day.selected_customers, depot, cl_wr_perc)
                                solution = clark_wright_sol.solve()
                                if solution:
                                    tabu_search = TabuSearch(clark_wright_sol, constant.MAX_TIME, perc_sw, tabu_l, num_p)
                                    ii=0
                    ...
                    print('Perc init {}, perc swap {}, tabu lenght {}, num perm {}'.format(cl_wr_perc, perc_sw, tabu_l, num_p))
