...
# ------------------------------------------------ INITIALIZATION -------------------------------------------------------
            ...
            # ------------------------------------------------ NP & NP_1 variables -------------------------------------------------------
                ...
                if policy == "NP" or policy == "NP_1":
                    ...
                    compatibility_list, compatibility_index, depot_distance = select_compatible_cells(distribution_df, depot, rho)
            ...
            # ------------------------------------------------- SIMULATION ---------------------------------------------------------
                ...
                for day in range(n_days):
                    ...
                    updated_day, num_postponed = select_customers(new_day, min_capacity, kg_capacity, policy, compatibility_list,\
                            distribution_df.probability, compatibility_index, depot_distance, m, thresh)
                ...
                print('M {} rho {} threshold'.format(m, rho, thresh))
